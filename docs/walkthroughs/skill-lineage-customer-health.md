...
description: Follow a single reusable skill — ranking your accounts worst-first by risk — as it grows across all three surfaces: a Cowork recipe you run on demand, an always-on Scout autopilot, and a hardened, governed tool in Copilot Studio.
stage: studio
...
## The skill we're following
One capability, stated in plain language: **"Rank my accounts worst-first by risk, tell me which ones are
moving the wrong way, and don't contact any customer without checking first."**
